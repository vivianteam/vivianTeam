          ...
          <div id="login">
            ...
            <form id= "form-login" action="{{route('loginPage')}}" method="post" class="beta-form-checkout">
              ...
              <div class="form-group">
                ...
                <input type="email" name="txt_Email" class="form-control" id="email" required pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" title="Email Format Invalid">
              </div>
              <div class="form-group">
                ...
                <input type="password" name="txt_Password" class="form-control" id="password" required pattern=".{6,}" title="Six or more characters">
              </div>
              <div class="row">
