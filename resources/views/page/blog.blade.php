              ...
              <form action="{!! route('getBlog')!!}">
                ...
                <div class="">
                  <div class="post">
                      ...
                      <div class="pull-left">
                        <div class="post__meta">
                          <span class="post__meta__item">
                            <input type="hidden" name="person_id" value="{{$person->id}}" id="{{$person->id}}">
                            <span class="autor">by
                    ...
                    <div class="post__meta">
                      <a href="{{route('getLikeTest01',$person->id)}}" style="margin-right: 20px" name="testCountLike" id="{{$person->id}}" >like ({{ $commentsCount}}) </a>
                      <span class="post__meta__item">
                      <span class="icon icon-message">
                      </span>
                      <a href="{{route('getcomment',$person->id)}}"> comment(s)
                      </a>
                    </span>
                    </div>
                  </div>
