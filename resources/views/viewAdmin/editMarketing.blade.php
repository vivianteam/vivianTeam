...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <a href="javascript:void(0);" class="btn btn-sm btn-danger 5bd0235daea98-delete" title="Delete">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_promotion/1" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="code" name="code" value="ABC-XAA01" class="form-control code" placeholder="Ví dụ: SAVEOFF2018,SAVE50,..." />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input style="width: 100px" type="text" id="reward" name="reward" value="100000" class="form-control reward" placeholder="Input Giá trị" />
...
<label for="type" class="col-sm-2  control-label">Loại</label>
    ...
    <div class="col-sm-8">
        ...
        <select class="form-control type" style="width: 100%;" name="type" data-value="0" >
                            <option value=""></option>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="data" name="data" value="Khuyến mãi đầu năm" class="form-control data" placeholder="Input Mô tả" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input style="width: 100px" type="text" id="number_uses" name="number_uses" value="100" class="form-control number_uses" placeholder="Input Số lần sử dụng" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input style="width: 160px" type="text" id="expires_at" name="expires_at" value="2018-08-11 00:00:00" class="form-control expires_at" placeholder="Input Ngày hết hạn" />
...
$('.5bd0235daea98-delete').unbind('click').click(function() {
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                $.ajax({
                    method: 'post',
                    url: 'https://demo.s-cart.org/system_admin/shop_promotion/1',
                    data: {
                        _method:'delete',
                        _token:LA.token,
                    },
                    success: function (data) {
                        $.pjax({container:'#pjax-container', url: 'https://demo.s-cart.org/system_admin/shop_promotion' });
