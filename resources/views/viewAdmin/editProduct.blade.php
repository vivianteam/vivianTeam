...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <a href="javascript:void(0);" class="btn btn-sm btn-danger 5bd02247ab87b-delete" title="Delete">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_product/49" method="post" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" pjax-container>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="en__name" name="en__name" value="Easy Polo Black Edition" class="form-control en__name" placeholder="Input Product name" />
    ...
    <div class="col-sm-8">
        ...
        <textarea class="form-control en__content" id="en__content" name="en__content" placeholder="Input Content"  >&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.&lt;/p&gt;</textarea>
...
<label for="category_id" class="col-sm-2  control-label">Shop category</label>
    ...
    <div class="col-sm-8">
        ...
        <select class="form-control category_id" style="width: 100%;" name="category_id" data-value="2" >
                            <option value=""></option>
                                    <option value="1" >SPORTSWEAR</option>
                                    <option value="11" >-- DIOR</option>
                                    <option value="12" >-- VALENTINO</option>
                                    <option value="2" selected>MENS</option>
    ...
    <div class="col-sm-8">
        ...
        <input type="file" class="image" name="image" data-initial-preview="http://demo.s-cart.org/documents/website/product/0950df6d59696ad39a8e5505735f578c.jpeg" data-initial-caption="0950df6d59696ad39a8e5505735f578c.jpeg" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input style="width: 120px" type="text" id="price" name="price" value="15000" class="form-control price" placeholder="Input Price for sale" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input style="width: 120px" type="text" id="cost" name="cost" value="15000" class="form-control cost" placeholder="Input Price cost" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input style="width: 100px" type="text" id="stock" name="stock" value="-12" class="form-control stock" placeholder="Input Stock" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="sku" name="sku" value="BX-5UTbnv" class="form-control sku" placeholder="Ex: ABKOOT01,ABKOOT02,..." />
...
<label for="brand_id" class="col-sm-2  control-label">Brands</label>
    ...
    <div class="col-sm-8">
        ...
        <select class="form-control brand_id" style="width: 100%;" name="brand_id" data-value="2" >
                            <option value=""></option>
                                    <option value="0" >-- Brands --</option>
                                    <option value="1" >Husq</option>
                                    <option value="2" selected>Ideal</option>
    ...
    <div class="col-sm-8">
                    ...
                    <input type="radio" name="type" value="0" class="minimal type"   />&nbsp;Default&nbsp;&nbsp;
                </label>
                                                <label class="radio-inline">
                    <input type="radio" name="type" value="1" class="minimal type" checked  />&nbsp;New&nbsp;&nbsp;
                </label>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input style="width: 160px" type="text" id="date_available" name="date_available" value="2018-09-19 00:00:00" class="form-control date_available" placeholder="Input Date available" />
...
<div id="has-many-images" class="has-many-images">
    ...
    <div class="col-sm-8">
        ...
        <input type="file" class="images 109 image" name="images[109][image]" data-initial-preview="http://demo.s-cart.org/documents/website/product_slide/e91e85e37bb89ed854aa4123ce5eb14f.jpeg" data-initial-caption="e91e85e37bb89ed854aa4123ce5eb14f.jpeg" />

        
    </div>
</div>

                                    <input type="hidden" name="images[109][id]" value="109" class="images 109 id"  />

                                    <input type="hidden" name="images[109][_remove_]" value="0" class="images 109 _remove_ fom-removed"  />
    ...
    <div class="col-sm-8">
        ...
        <input type="file" class="images 113 image" name="images[113][image]" data-initial-preview="http://demo.s-cart.org/documents/website/product_slide/7963a1dc4e1676c2b3bc97ade96de7b6.jpeg" data-initial-caption="7963a1dc4e1676c2b3bc97ade96de7b6.jpeg" />

        
    </div>
</div>

                                    <input type="hidden" name="images[113][id]" value="113" class="images 113 id"  />

                                    <input type="hidden" name="images[113][_remove_]" value="0" class="images 113 _remove_ fom-removed"  />
...
$('.5bd02247ab87b-delete').unbind('click').click(function() {
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                $.ajax({
                    method: 'post',
                    url: 'https://demo.s-cart.org/system_admin/shop_product/49',
                    data: {
                        _method:'delete',
                        _token:LA.token,
                    },
                    success: function (data) {
                        $.pjax({container:'#pjax-container', url: 'https://demo.s-cart.org/system_admin/shop_product' });
...
$("input.image").fileinput({"overwriteInitial":true,"initialPreviewAsData":true,"browseLabel":"Browse","showRemove":false,"showUpload":false,"deleteExtraData":{"image":"_file_del_","_file_del_":"","_token":"YkDCfkRWPRyZTW2zQVo3IfKy3x6paUJmuFe7BBwx","_method":"PUT"},"deleteUrl":"https:\/\/demo.s-cart.org\/system_admin\/shop_product\/49","allowedFileTypes":["image"]});
...
$("input.images.109.image").fileinput({"overwriteInitial":true,"initialPreviewAsData":true,"browseLabel":"Browse","showRemove":false,"showUpload":false,"deleteExtraData":{"image":"_file_del_","_file_del_":"","_token":"YkDCfkRWPRyZTW2zQVo3IfKy3x6paUJmuFe7BBwx","_method":"PUT"},"deleteUrl":"https:\/\/demo.s-cart.org\/system_admin\/shop_product\/49","allowedFileTypes":["image"]});

                    
$("input.images.113.image").fileinput({"overwriteInitial":true,"initialPreviewAsData":true,"browseLabel":"Browse","showRemove":false,"showUpload":false,"deleteExtraData":{"image":"_file_del_","_file_del_":"","_token":"YkDCfkRWPRyZTW2zQVo3IfKy3x6paUJmuFe7BBwx","_method":"PUT"},"deleteUrl":"https:\/\/demo.s-cart.org\/system_admin\/shop_product\/49","allowedFileTypes":["image"]});
