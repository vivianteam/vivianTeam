...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/cms_page/2" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="en__title" name="en__title" value="Contact" class="form-control en__title" placeholder="Input Tên" />
    ...
    <div class="col-sm-8">
        ...
        <textarea class="form-control en__content" id="en__content" name="en__content" placeholder="Input Content"  ></textarea>
                                                    ...
                                                    <hr>
                                                    <div class="form-group ">
    <label class="col-sm-2  control-label">Unique Key</label>
    <div class="col-sm-8">
