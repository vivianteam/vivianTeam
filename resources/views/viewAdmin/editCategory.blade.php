...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <a href="javascript:void(0);" class="btn btn-sm btn-danger 5bd021dd34f95-delete" title="Delete">
        <i class="fa fa-trash"></i><span class="hidden-xs">  Delete</span>
    </a>
</div><div class="btn-group pull-right" style="margin-right: 5px">
    <a href="https://demo.s-cart.org/system_admin/shop_category" class="btn btn-sm btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;List</span></a>
</div>
        </div>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_category/18" method="post" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" pjax-container>
    ...
    <label for="en__name" class="col-sm-2  control-label">Tên</label>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="en__name" name="en__name" value="ADIDAS" class="form-control en__name" placeholder="Input Tên" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="en__keyword" name="en__keyword" value="Arduino Shield" class="form-control en__keyword" placeholder="Input Keyword" />
...
<label for="parent" class="col-sm-2  control-label">Parent category</label>
    ...
    <div class="col-sm-8">
        ...
        <select class="form-control parent" style="width: 100%;" name="parent" data-value="3" >
                            <option value=""></option>
                                    ...
                                    <option value="3" selected>WOMENS</option>
    ...
    <div class="col-md-8">
            ...
            <button type="reset" class="btn btn-warning">Reset</button>
                    ...
                    <input type="hidden" name="_previous_" value="https://demo.s-cart.org/system_admin/shop_category" class="_previous_"  />
...
$('.5bd021dd34f95-delete').unbind('click').click(function() {
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                $.ajax({
                    method: 'post',
                    url: 'https://demo.s-cart.org/system_admin/shop_category/18',
                    data: {
                        _method:'delete',
                        _token:LA.token,
                    },
                    success: function (data) {
                        $.pjax({container:'#pjax-container', url: 'https://demo.s-cart.org/system_admin/shop_category' });
