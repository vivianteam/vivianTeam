...
<head>
    ...
    <title>S-cart Admin  | Thêm  status mới</title>
...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_shipping_status" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
