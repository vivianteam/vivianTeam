...
<head>
    ...
    <title>S-cart Admin  | Trạng thái thanh toán</title>
...
<div class="btn-group pull-right" style="margin-right: 10px">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="/system_admin/shop_payment_status?_export_=all" target="_blank">All</a></li>
        <li><a href="/system_admin/shop_payment_status?_export_=page%3A1" target="_blank">Current page</a></li>
        <li><a href="/system_admin/shop_payment_status?_export_=selected%3A__rows__" target="_blank" class='export-selected'>Selected rows</a></li>
    </ul>
</div>
            
<div class="btn-group pull-right" style="margin-right: 10px">
    <a href="/system_admin/shop_payment_status/create" class="btn btn-sm btn-success" title="New">
...
<div class="btn-group">
    ...
    <label class="btn btn-sm btn-dropbox 5bcf39bb3817a-filter-btn " title="Filter">
    ...
    <form action="https://demo.s-cart.org/system_admin/shop_payment_status" class="form-horizontal" pjax-container method="get">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="btn-group pull-left " style="margin-left: 10px;">
                            <a href="https://demo.s-cart.org/system_admin/shop_payment_status" class="btn btn-default btn-sm"><i
    ...
    <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
            <thead>
                <tr>
                                        <th> </th>
                                        <th>ID<a class="fa fa-fw fa-sort" href="https://demo.s-cart.org/system_admin/shop_payment_status?_sort%5Bcolumn%5D=id&_sort%5Btype%5D=desc"></a></th>
                                        <th>Tên trạng thái<a class="fa fa-fw fa-sort" href="https://demo.s-cart.org/system_admin/shop_payment_status?_sort%5Bcolumn%5D=name&_sort%5Btype%5D=desc"></a></th>
                                        <th>Action</th>
                                    </tr>
            </thead>
            ...
            <tbody>
                        ...
                        0
                                        ...
                                        <td >
                        Chưa thanh to&aacute;n
                    </td>
                                        <td >
                        <a href="/system_admin/shop_payment_status/0/edit">
    ...
    <i class="fa fa-trash"></i>
                        ...
                        1
                                        ...
                                        <td >
                        Thanh to&aacute;n một phần
                    </td>
                                        <td >
                        <a href="/system_admin/shop_payment_status/1/edit">
    <i class="fa fa-edit"></i>
    ...
    <i class="fa fa-trash"></i>
                        ...
                        2
                                        ...
                                        <td >
                        Thanh to&aacute;n xong
                    </td>
                                        <td >
                        <a href="/system_admin/shop_payment_status/2/edit">
    <i class="fa fa-edit"></i>
    ...
    <i class="fa fa-trash"></i>
                        ...
                        3
                                        ...
                                        <td >
                        Kh&aacute;ch h&agrave;ng dư tiền
                    </td>
                                        <td >
                        <a href="/system_admin/shop_payment_status/3/edit">
    <i class="fa fa-edit"></i>
    ...
    <div class="box-footer clearfix">
        Showing <b>1</b> to <b>4</b> of <b>4</b> entries<ul class="pagination pagination-sm no-margin pull-right">
    <!-- Previous Page Link -->
...
<label class="control-label pull-right" style="margin-right: 10px; font-weight: 100;">
        ...
        <select class="input-sm grid-per-pager" name="per-page">
            <option value="https://demo.s-cart.org/system_admin/shop_payment_status?per_page=10" >10</option>
<option value="https://demo.s-cart.org/system_admin/shop_payment_status?per_page=20" selected>20</option>
<option value="https://demo.s-cart.org/system_admin/shop_payment_status?per_page=30" >30</option>
<option value="https://demo.s-cart.org/system_admin/shop_payment_status?per_page=50" >50</option>
<option value="https://demo.s-cart.org/system_admin/shop_payment_status?per_page=100" >100</option>
        </select>
        &nbsp;<small>entries</small>
    </label>
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                $.ajax({
                    method: 'post',
                    url: '/system_admin/shop_payment_status/' + id,
                    data: {
                        _method:'delete',
                        _token:LA.token,
                    },
...
$('.grid-refresh').on('click', function() {
    ...
    toastr.success('Refresh succeeded !');
                    ...
                    $('.5bcf39bb3817a-filter-btn').click(function (e) {
