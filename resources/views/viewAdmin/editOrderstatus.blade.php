...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <a href="javascript:void(0);" class="btn btn-sm btn-danger 5bd022b5b0df4-delete" title="Delete">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_order_status/0" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="name" name="name" value="Mới" class="form-control name" placeholder="Input Tên" />
...
$('.5bd022b5b0df4-delete').unbind('click').click(function() {
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                $.ajax({
                    method: 'post',
                    url: 'https://demo.s-cart.org/system_admin/shop_order_status',
                    data: {
                        _method:'delete',
                        _token:LA.token,
                    },
                    success: function (data) {
                        $.pjax({container:'#pjax-container', url: 'https://demo.s-cart.org/system_admin/shop_order_status' });
