...
<head>
    ...
    <title>S-cart Admin  | Thêm mới trạng thái thanh toán</title>
...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_payment_status" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="name" name="name" value="" class="form-control name" placeholder="Input Tên trạng thái" />
