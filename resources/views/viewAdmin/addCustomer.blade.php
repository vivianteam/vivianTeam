...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_customer" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="email" id="email" name="email" value="" class="form-control email" placeholder="Input Email" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="address1" name="address1" value="" class="form-control address1" placeholder="Input Address 1" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="address2" name="address2" value="" class="form-control address2" placeholder="Input Address 2" />
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="phone" name="phone" value="" class="form-control phone" placeholder="Input Phone" />
