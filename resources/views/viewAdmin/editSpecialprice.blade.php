...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <a href="javascript:void(0);" class="btn btn-sm btn-danger 5bd0220397328-delete" title="Delete">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_special_price/15" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
...
<label for="product_id" class="col-sm-2  control-label">Product</label>
    ...
    <div class="col-sm-8">
        ...
        <select class="form-control product_id" style="width: 100%;" name="product_id" data-value="3" >
                            <option value=""></option>
                                    ...
                                    <option value="3" selected>Easy Polo Black Edition (MEGA2560)</option>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input style="width: 120px" type="text" id="price" name="price" value="200000" class="form-control price" placeholder="Input Special price" />
...
$('.5bd0220397328-delete').unbind('click').click(function() {
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                $.ajax({
                    method: 'post',
                    url: 'https://demo.s-cart.org/system_admin/shop_special_price/15',
                    data: {
                        _method:'delete',
                        _token:LA.token,
                    },
                    success: function (data) {
                        $.pjax({container:'#pjax-container', url: 'https://demo.s-cart.org/system_admin/shop_special_price' });
