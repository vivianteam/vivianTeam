  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="{{route('getContact')}}"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Management Contacts</span></a></li>
        <li class=" nav-item"><a href="{{route('getManagementOrder')}}"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Management Orders</span></a></li>
        <li class=" nav-item"><a href="{{route('request')}}"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">Management requests</span></a></li>
