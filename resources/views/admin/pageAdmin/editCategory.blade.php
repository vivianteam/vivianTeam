                ...
                <form class="form form-horizontal" id="edit_categories" action="{{ route('geteditCategory',$data['id']) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" id="projectinput5" class="form-control" placeholder="Category name" maxlength="50" name="txt_thienTest" required pattern="^[a-zA-Z ]*$" title="Category Name Invalid" value="{!! old('txt_thienTest',isset($data)? $data['name']: null) !!}">
                      </div>
                    </div>
                     <div class="form-group row">
