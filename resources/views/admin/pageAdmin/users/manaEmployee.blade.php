        ...
        <div class="card">
          <div class="card-head">
            <div class="card-header">
              <h4 class="card-title">All Empployee
              </h4>
                ...
                <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @if($customer->type==2)
                          <button type="text-align" class="btn btn-warning">Admin</button>
                        @else
                          <button type="text-align" class="btn btn-info">Staff</button>
                        @endif
                      </td>
                      <td>
                        <a href="{{route('geteditEmployess',$customer['id'])}}">
                        ...
                        <a href="{{route('getdeleteEmployess',$customer['id'])}}">
