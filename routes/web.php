...
Route::get('editManagementOrder/{id}',[
	'as'=>'getEditManagementOrder',
	'uses'=>'controllerOrder@getEditManagementOrder'
]);
Route::post('editManagementOrder/{id}',[
	'as'=>'postEditManagementOrder',
	'uses'=>'controllerOrder@postEditManagementOrder'
]);
